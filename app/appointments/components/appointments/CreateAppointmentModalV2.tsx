...
interface CreateAppointmentModalProps {
  ...
  onSubmit: (data: CreateAppointmentSchemaValues) => Promise<void>;
  onClose: () => void;
...
const CreateAppointmentModalV2 = (props: CreateAppointmentModalProps) => {
  ...
  const isSubmitPending = isSubmitting || Boolean(props.isSubmitting);

  const onSubmit = async (data: CreateAppointmentSchemaValues) => {
            ...
            <div className="space-y-2">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">
                  {isSubmitPending ? "Creating appointment..." : ""}
                </p>
              </div>
            </div>
            <button
            ...
            <div className="flex flex-wrap justify-end gap-3 pt-2">
              ...
              <button
                ...
                className={`inline-flex h-11 items-center justify-center rounded-2xl bg-slate-950 px-4 text-sm font-medium text-white transition ${
                  !isDirty || !isValid || isSubmitPending
                    ? "cursor-not-allowed opacity-50"
                    : "hover:bg-slate-800"
                }`}
                disabled={!isDirty || !isValid || isSubmitPending}
              >
...
export default CreateAppointmentModalV2;
